 ...
 * 設定型定義モジュール
 *
 * miipaアプリケーションの設定に関する型定義とZodスキーマを提供します。
 ...
 * アプリケーション設定のZodスキーマ
 *
 * miipaアプリケーション全体の設定を定義するルートスキーマです。
 * このスキーマを使用して `~/.miipa/config.json` をバリデーションします。
 *
 * @remarks
 ...
 * アプリケーション設定
 *
 * miipaアプリケーション全体の設定を定義するルート型です。
 * この型はZodスキーマから推論されており、ランタイムバリデーションと
 * 型チェックが完全に一致することを保証しています。
 *
 * @remarks
 * 設定ファイルは `~/.miipa/config.json` に保存されます。
